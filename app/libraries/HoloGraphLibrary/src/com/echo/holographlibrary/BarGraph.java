...
public class BarGraph extends View {
    ...
    public void onDraw(Canvas ca) {
        ...
        if (fullImage == null || shouldUpdate) {
            ...
            // Line between DAYS and BARS
            p.setColor(Color.BLACK);
            p.setStrokeWidth(0); // was 2
            p.setAlpha(50);
            p.setAntiAlias(true);

            canvas.drawLine(0, getHeight() - bottomPadding + 5, getWidth(), getHeight() - bottomPadding + 5, p); // 5's were 10's
            ...
            for (Bar p : points) {
                ...
                this.p.setTextSize(30); // DAY NAME (was 20)
